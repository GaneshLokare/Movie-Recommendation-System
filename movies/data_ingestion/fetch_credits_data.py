...
from movies.constants.data_ingestion_constants import start_index, end_index ,credits_data_path
    ...
    def fetch_data():
        try:
            ...
            for i in range(start_index,end_index):
                res = requests.get("https://api.themoviedb.org/3/movie/{}/credits?api_key=8265bd1679663a7ea12ac168da84d2e8&language=en-US".format(i))
                array = res.json()
